CREATE DATABASE  IF NOT EXISTS `puppy_love_cafe` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `puppy_love_cafe`;
...
INSERT INTO `food_items` VALUES (1,'Paw-tato Skins',8.99),(2,'Kitty Caprese',10.99),(3,'Bunny Bites',7.99),
(4,'Pug Burger',12.99),(5,'Meow Meow Tacos',11.99),(6,'Bark-B-Q Ribs',14.99),(7,'Fluffy Frittata',9.99),(8,'Puppy Dog Pasta',6.99),(9,'Mini Moo Burgers',7.99),
(10, 'Bunny Bliss', 6.99), (11, 'Cocoa Cuddle', 3.99), (12, 'Doggy Chino', 4.99);
...
INSERT INTO `orders` VALUES (40,1,2,17.98),(40,3,1,23.97),(41,4,3,38.97),(41,6,2,44.97),(41,9,4,31.96);
